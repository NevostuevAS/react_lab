...
/*
  ...
  Да, есть разница.
  setWalk — это асинхронная функция, которая планирует обновление состояния. Обновление состояния не происходит мгновенно, а происходит после завершения текущего обработчика и перерисовки компонента.
*/
